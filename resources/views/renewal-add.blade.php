            ...
            <div class="tabbable-custom tabbable-parallel">
                ...
                <div class="tab-content no-padding" style=" border-top: 2px solid #f5f5f5;">
                    <div class="tab-pane active" id="listing-add">
                        <form action="{{route('renewal.create')}}" method="post">
                            {{ csrf_field() }}
                            <div class="row">
                                @if(count($errors) > 0)
                                ...
                                <div class="col-md-12" style="padding-left: 50px;margin-top:30px;">
                                    <div class="row">
                                        <div class="col-md-5">
                                            ...
                                            <div class="row" style="margin-bottom: 15px; border-bottom: 1px solid #c2cad8; margin-left: 0px; margin-right: 0px;">
                                                <div class="form-group">
                                                    <label class="control-label col-md-12 bold text-center" style="margin-top:7px;">Insurance</label>
                                                </div>
                                            </div>
                                            <div class="row" style="margin-bottom: 15px;">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="text" name="insurance" class="form-control"
                                                               placeholder="Insurance" value="{{ old('insurance') }}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row" style="margin-bottom: 15px;">
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="input-group date date-picker margin-bottom-5"
                                                            ...
                                                            <input type="text" class="form-control form-filter input-sm"
                                                                   readonly
                                                                   name="insurance_last_renewal"
                                                                   placeholder="Last Renewal"
                                                                   value="{{old('insurance_last_renewal')}}">
                                            ...
                                            <div class="row" style="margin-bottom: 15px; border-bottom: 1px solid #c2cad8; margin-left: 0px; margin-right: 0px;">
                                                <div class="form-group">
                                                    <label class="control-label col-md-12 bold text-center" style="margin-top:7px;">Road Tax</label>
                                                </div>
                                            </div>
                                            <div class="row" style="margin-bottom: 15px;">
                                                <div class="form-group">
                                                    <label class="control-label col-md-4 bold" style="margin-top:7px;">Road Tax</label>
                                                    <div class="col-md-8">
                                                        <input type="text" name="road_tax" class="form-control"
                                                               placeholder="Road Tax" value="{{ old('road_tax') }}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row" style="margin-bottom: 15px;">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="input-group date date-picker margin-bottom-5"
                                                            ...
                                                            <input type="text" class="form-control form-filter input-sm"
                                                                   readonly
                                                                   name="road_tax_last_renewal"
                                                                   placeholder="Last Renewal"
                                                                   value="{{old('road_tax_last_renewal')}}">
                                                            <span class="input-group-btn">
                                                                <button class="btn btn-sm default" type="button">
                                                                <i class="fa fa-calendar"></i>
                                                                </button>
                                        ...
                                        <div class="col-md-5 col-md-offset-1">
                                            <div class="row" style="margin-bottom: 15px; border-bottom: 1px solid #c2cad8; margin-left: 0px; margin-right: 0px;">
                                                <div class="form-group">
                                                    <label class="control-label col-md-12 bold text-center" style="margin-top:7px;">Puspakom</label>
                                                </div>
                                            </div>
                                            <div class="row" style="margin-bottom: 15px;">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="text" name="puspakom" class="form-control"
                                                               placeholder="Puspakom" value="{{ old('puspakom') }}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row" style="margin-bottom: 15px;">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="input-group date date-picker margin-bottom-5"
                                                            ...
                                                            <input type="text" class="form-control form-filter input-sm"
                                                                   readonly
                                                                   name="puspakom_last_renewal"
                                                                   placeholder="Last Renewal"
                                                                   value="{{old('puspakom_last_renewal')}}">
                                                            <span class="input-group-btn">
                                                                <button class="btn btn-sm default" type="button">
                                                                <i class="fa fa-calendar"></i>
                                                                </button>
