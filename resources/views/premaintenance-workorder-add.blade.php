        ...
        <div class="portlet-body no-padding" style=" background: #f3f3f4;">
            <div class="tabbable-custom tabbable-parallel">
                <ul class="nav nav-tabs ">
                    <li class="active" style="width: 220px; background-color: white !important;">
                    ...
                    <div class="tab-pane active" id="listing-add">
                        <form action="{{route('workorder.create')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                @endif
                                <input type="hidden" name="pre_maintenance_id" value="{{$premaintenance->id}}">
                                                        ...
                                                        <select name="type" class="form-control">
                                                            @foreach($types as $type)
                                                                <option value="{{ $type->id }}"
                                                                        @if($premaintenance->type_id== $type->id) selected @endif>{{ $type->name }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                                        ...
                                                        <select name="model" class="form-control">
                                                            @foreach($models as $model)
                                                                <option value="{{ $model->id }}"
                                                                        @if($premaintenance->model_id == $model->id) selected @endif>{{ $model->name }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row" style="margin-bottom: 15px;">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="input-group date form_datetime">
                                                            <input type="text" readonly class="form-control"
                                                                   placeholder="Estimation Completion Time"
                                                                   name="estimate_time"
                                                                   value="{{old('estimate_time') }}">
                                                            <span class="input-group-btn">
                                                            <button class="btn default date-set" type="button">
                                                                <i class="fa fa-calendar"></i>
                                                            </button>
