            ...
            <div class="tabbable-custom tabbable-parallel">
                <ul class="nav nav-tabs ">
                    <li class="active" style="width: 180px; background-color: white !important;">
                        <a href="#listing-add" data-toggle="tab" style="color: black !important;"> Brand ->
                            EDIT </a>
                    </li>
                </ul>
                <div class="tab-content no-padding" style=" border-top: 2px solid #f5f5f5;">
                    <div class="tab-pane active" id="listing-add">
                        <form action="{{route('machinery.brand.update')}}" method="post">
                            {{ csrf_field() }}
                            <div class="row">
                                        ...
                                        <div class="col-md-5">
                                            ...
                                            <div class="row" style="margin-bottom: 15px;">
                                                <div class="form-group">
                                                    <label class="control-label col-md-3 bold" style="margin-top:7px;">Brand</label>
                                                    <div class="col-md-8">
                                                        <input name="brand" type="text" class="form-control"
                                                               placeholder="Brand" value="{{$brand->name}}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row" style="margin-bottom: 15px;">
                            ...
                            <div class="action-toolbar">
                                <a class="btn btn-sm dark"
                                   ...
                                   href="{{ route('machinery', ['type' => 'brand']) }}">DISCARD</a>
