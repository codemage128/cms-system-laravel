            ...
            <div class="tabbable-custom tabbable-parallel">
                ...
                <div class="tab-content no-padding" style=" border-top: 2px solid #f5f5f5;">
                    <div class="tab-pane active" id="listing-add">
                        <form action="{{route('premaintenance.update')}}" method="post">
                            {{ csrf_field() }}
                            <div class="row">
                                @if(count($errors) > 0)
                                                        ...
                                                        <select name="brand" class="form-control">
                                                            @foreach($brands as $brand)
                                                                <option value="{{ $brand->id }}"
                                                                        @if($premaintenance->brand_id == $brand->id) selected @endif>{{ $brand->name }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="input-group date date-picker margin-bottom-5"
                                                            ...
                                                            <input type="text" class="form-control form-filter input-sm"
                                                                   ...
                                                                   value="{{ $premaintenance->last_service_date }}">
