            ...
            <div class="tabbable-custom tabbable-parallel">
                ...
                <div class="tab-content no-padding" style=" border-top: 2px solid #f5f5f5;">
                    <div class="tab-pane active" id="listing-add">
                        <form action="{{route('diesal.update')}}" method="post">
                            {{ csrf_field() }}
                            <div class="row">
                                ...
                                @endif
                                <input type="hidden" name="id" value="{{$diesel->id}}">
                                <div class="col-md-12" style="padding-left: 50px;margin-top:20px;">
                                    <div class="row">
                                        <div class="col-md-5">
                                                        ...
                                                        <select name="type" class="form-control">
                                                            @foreach($types as $type)
                                                                <option value="{{ $type->id }}"
                                                                        @if($diesel->type_id == $type->id) selected @endif>{{ $type->name }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="input-group date date-picker margin-bottom-5"
                                                            ...
                                                            <input type="text" class="form-control" name="month_year"
                                                                   readonly value="{{$diesel->month_year}}">
                                                            <span class="input-group-btn">
                                    ...
                                    <div class="row">
                                        <div class="col-md-7">
                                            <table class="table table-striped table-hover"
                                                ...
                                                @if($diesel->items)
                                                    @foreach($diesel->items as  $key => $diesel)
                                                        <tr data-id="{{$key}}">
                                                            <td>
                                                                <div class="input-group date date-picker margin-bottom-5"
                                                                     data-date-format="yyyy-mm-dd">
